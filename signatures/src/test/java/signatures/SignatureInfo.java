...
public class SignatureInfo {
    ...
    private AcroFields.FieldPosition signaturePosition;
    ...
    public void setSignaturePosition(AcroFields.FieldPosition signaturePosition) {
        this.signaturePosition = signaturePosition;
    }

    public AcroFields.FieldPosition getSignaturePosition() {
